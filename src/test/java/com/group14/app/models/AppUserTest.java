...
public class AppUserTest {
	...
	public void isValidUserTest() {
		...
		assertEquals(false, user.isValidUser());// Testing for invalid userID - Must be starting with B00 and have 6 digits after		
		...
		assertEquals(false, user.isValidUser());// Testing for invalid email - must not have any special characters apart from period
