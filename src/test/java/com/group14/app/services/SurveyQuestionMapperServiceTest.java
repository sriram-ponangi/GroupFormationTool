...
public class SurveyQuestionMapperServiceTest {
	...
	public void deleteSurveyQuestion() throws SQLException {
		...
		when(this.sQMR.deleteSurveyQuestion(surveyQuestionMapper.getQuestionId(), surveyQuestionMapper.getSurveyId())).thenReturn(mockDBResponse);
		
		int response = sQMS.deleteSurveyQuestion(surveyQuestionMapper.getQuestionId(), surveyQuestionMapper.getSurveyId());
	...
	public void createSurveyQuestion() throws SQLException {
		...
		when(this.sQMR.addSurveyQuestion(surveyQuestionMapper.getQuestionId(), surveyQuestionMapper.getSurveyId())).thenReturn(mockDBResponse);
