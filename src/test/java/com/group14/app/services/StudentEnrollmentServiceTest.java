...
public class StudentEnrollmentServiceTest {
	...
	@BeforeEach
	public void setup() {
		this.studentEnrollmentService = new StudentEnrollmentService(studentEnrollmentRepository, parseCSV, emailSenderService);
	...
	public void enrollStudentsToCourseTest_basic() {
		...
		// Using Mockito.any() because the focus of this Class is to test the service class not the repository.
